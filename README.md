...
**Последняя версия — 1.3.4.1.** Личная карта бесплатна. Доступ к отрядам активируется выданным ключом; приём оплаты пока не открыт.
...
## Новое в версии 1.3.4.1

**Карта отряда остаётся с вами.** Полученные точки и позиции товарищей сохраняются после закрытия карты и перезапуска Navigator. Нажмите **«Обновить точки отряда»** или **F11**, когда нужны свежие данные. При обрыве связи последняя полученная карта остаётся видимой. Исправлено появление общих точек после перемещения карты.

Позиция товарища сохраняется с временем передачи: она обновится, когда он отправит её снова.
